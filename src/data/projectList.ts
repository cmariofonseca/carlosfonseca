...
export const projectList: Project[] = [
  ...
  },
  {
    ...
    date: "2024",
    description:
      "App para autorizar mediante doble factor de autenticacion los giros, cambios de fondos y actualización de datos que el usuario realiza en la pagina de la Nueva web Sura.",
    developmentCompany: "CleverIt | Chile",
    id: "cleverit-sura-1",
    imageUrl: "/projects/capital-pass.png",
    industry: "Seguros",
    isPersonalProject: false,
